...
export default function App() {
  ...
  const [products, setProducts] = useState<Product[]>(() => {
    ...
    const imageFix: Record<string, string> = {
      ...
      'hot-3': '/images/Hot Crispy salmão.jpg',
      'hot-5': '/images/Hot Aberto.jpg',
      'hot-6': '/images/Hot Temaki.jpg',
      'hot-7': '/images/Hot Temaki sem Arroz.jpg',
      'temaki-1': '/images/Temaki em cubos.jpg',
      ...
      'sushi-10': '/images/Hossomaki (8 peças).jpg',
      'barca-1': '/images/Barca.jpg',
      'adicional-1': '/images/Molho Tare.jpg',
      'special-1': '/images/Pote da felicidade.jpg',
      'bebida-1': '/images/Coca lata  .jpg',
      'bebida-2': '/images/Coca lata zero.jpg',
      'bebida-3': '/images/Fanta lata uva.jpg',
      'bebida-4': '/images/Fanta lata laranja.jpg',
