...
import { X, ShoppingBasket, Plus, Minus, Edit2, Trash2, Ticket, Check, ChevronRight, AlertCircle, ShoppingBag } from 'lucide-react';
...
export default function CartDrawer({
  ...
  if (appliedCoupon && appliedCoupon.isActive) {
    ...
    if (subtotal < minVal) {
      // Coupon was applied but now subtotal fell below min requirement
      setTimeout(() => {
        onApplyCoupon(null);
