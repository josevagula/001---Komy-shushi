...
export const initialRestaurantConfig: RestaurantConfig = {
  name: "KOMY SUSHI",
  logo: "/src/assets/images/komy_sushi_logo_1781050151731.png",
  banner: "/src/assets/images/sushi_banner_premium_dark_1781131159755.png",
...
export const initialProducts: Product[] = [
  // --- DESTAQUE ---
  {
    ...
    price: 36.99,
    category: "Promoções",
    image: "/src/assets/images/hot_roll_premium_1781053951166.png",
    rating: 5.0,
    prepTime: "20-25 min",
    isBestSeller: true,
  ...
  // --- SUSHIS (Includes all sushi varieties, sashimis, combos, combinados, pokes, etc) ---
  {
    ...
    price: 19.99,
    category: "Sushis",
    image: "/src/assets/images/sunomono_real_1781054298241.png",
    rating: 5.0,
    prepTime: "10-15 min",
  ...
  },
  {
    ...
    price: 36.99,
    category: "Sushis",
    image: "https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "20-25 min",
  ...
  },
  {
    ...
    price: 36.99,
    category: "Sushis",
    image: "/src/assets/images/hot_couve_crispy_1781052797955.png",
    rating: 5.0,
    prepTime: "20-25 min",
    isFeatured: true,
  ...
  },
  {
    ...
    price: 36.99,
    category: "Sushis",
    image: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "20-25 min",
  ...
  },
  {
    ...
    price: 38.99,
    category: "Sushis",
    image: "/src/assets/images/hot_aberto_real_1781054313711.png",
    rating: 5.0,
    prepTime: "15-20 min",
  ...
  },
  {
    ...
    price: 39.99,
    category: "Sushis",
    image: "/src/assets/images/hot_temaki_lying_table_1781055129959.png",
    rating: 5.0,
    prepTime: "15-20 min",
    isBestSeller: true,
    ingredients: ["Arroz", "Nori", "Salmão", "Cream Cheese", "Cebolinha Verde", "Molho Tarê"],
  ...
  },
  {
    ...
    price: 44.99,
    category: "Sushis",
    image: "/src/assets/images/hot_temaki_no_rice_lying_table_1781055147154.png",
    rating: 5.0,
    prepTime: "15-20 min",
  ...
  // --- SASHIMI (under category "Sushis") ---
  {
    ...
    price: 36.99,
    category: "Sushis",
    image: "/src/assets/images/sashimi_fresh_slices_real_1781055163411.png",
    rating: 5.0,
    prepTime: "10-15 min",
  ...
  },
  {
    ...
    price: 38.99,
    category: "Sushis",
    image: "/src/assets/images/sashimi_seared_slices_real_1781055180278.png",
    rating: 5.0,
    prepTime: "12-18 min",
  ...
  // --- TEMAKI (under category "Sushis") ---
  {
    ...
    price: 33.99,
    category: "Sushis",
    image: "https://images.unsplash.com/photo-1617196034183-421b4917c92d?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "10-15 min",
    isBestSeller: true,
  ...
  // --- SUSHIS - all 8 unidades (under category "Sushis") ---
  {
    ...
    price: 37.99,
    category: "Sushis",
    image: "/src/assets/images/niguiri_salmao_real_1781055795296.png",
    rating: 5.0,
    prepTime: "12-18 min",
  ...
  },
  {
    ...
    price: 39.99,
    category: "Sushis",
    image: "/src/assets/images/niguiri_macaricado_real_1781055808570.png",
    rating: 5.0,
    prepTime: "12-18 min",
  ...
  },
  {
    ...
    price: 37.99,
    category: "Sushis",
    image: "/src/assets/images/joy_macaricado_real_1781055818957.png",
    rating: 5.0,
    prepTime: "15-20 min",
  ...
  },
  {
    ...
    price: 40.99,
    category: "Sushis",
    image: "https://images.unsplash.com/photo-1553621042-f6e147245754?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "15-20 min",
  ...
  },
  {
    ...
    price: 31.99,
    category: "Sushis",
    image: "https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "10-15 min",
  ...
  // --- COMBOS (under category "Sushis") ---
  {
    ...
    price: 38.99,
    category: "Sushis",
    image: "/src/assets/images/sushi_combo_real_1781055442244.png",
    rating: 5.0,
    prepTime: "20-25 min",
  ...
  // --- COMBINADOS (under category "Sushis") ---
  {
    ...
    price: 76.99,
    category: "Sushis",
    image: "/src/assets/images/sushi_combinado_real_1781055460922.png",
    rating: 5.0,
    prepTime: "30-40 min",
    isBestSeller: true,
  ...
  // --- POKE (under category "Sushis") ---
  {
    ...
    description: "Arroz, cream cheese, salmão grelhado, sunomono, couve crispy, batata doce crispy, tomate cereja, cebola roxa, cebolinha verde, gergelim & molho tarê — aprox. 400g",
    price: 47.99,
    category: "Sushis",
    image: "/src/assets/images/poke_salmao_grelhado_real_1781055196359.png",
    rating: 5.0,
    prepTime: "15-20 min",
    ingredients: ["Arroz", "Cream Cheese", "Salmão Grelhado", "Sunomono", "Couve Crispy", "Batata Crispy", "Tomate Cereja", "Cebola Roxa", "Cebolinha Verde", "Gergelim", "Molho Tarê"],
    availableToppings: standardSushiToppings
  },
  {
    id: "poke-2",
    name: "Poke Salmão em Cubos",
    description: "Arroz, cream cheese, salmão em cubos, sunomono, couve crispy, batata doce crispy, tomate cereja, cebola roxa, cebolinha verde, gergelim & molho tarê — aprox. 400g",
    price: 44.99,
    category: "Sushis",
    image: "/src/assets/images/poke_salmao_cubos_1781054955550.png",
    rating: 5.0,
    prepTime: "15-20 min",
    isBestSeller: true,
    ingredients: ["Arroz", "Cream Cheese", "Salmão em Cubos", "Sunomono", "Couve Crispy", "Batata Crispy", "Tomate Cereja", "Cebola Roxa", "Cebolinha Verde", "Gergelim", "Molho Tarê"],
    availableToppings: standardSushiToppings
  },
  ...
  // --- SOBREMESA - ICHIGO (under category "Sushis") ---
  {
    ...
    price: 33.99,
    category: "Sushis",
    image: "/src/assets/images/ichigo_sweet_1781052762028.png",
    rating: 5.0,
    prepTime: "10-15 min",
    isBestSeller: true,
  ...
  // --- POTE DA FELICIDADE (under category "Sushis") ---
  {
    ...
    price: 31.99,
    category: "Sushis",
    image: "/src/assets/images/pote_felicidade_real_1781055478399.png",
    rating: 5.0,
    prepTime: "10-15 min",
  ...
  // --- BURGER KOMY (under category "Sushis") ---
  {
    ...
    price: 46.99,
    category: "Sushis",
    image: "/src/assets/images/burger_komy_1781052743744.png",
    rating: 5.0,
    prepTime: "18-25 min",
    isFeatured: true,
  ...
  },
  {
    ...
    price: 41.99,
    category: "Sushis",
    image: "/src/assets/images/burger_komy_cubos_1781054809469.png",
    rating: 5.0,
    prepTime: "18-25 min",
  ...
  // --- ADICIONAL (under category "Sushis") ---
  {
    ...
    price: 6.00,
    category: "Sushis",
    image: "/src/assets/images/molho_tare_1781053607350.png",
    rating: 5.0,
    prepTime: "1 min",
  ...
  // --- BEBIDAS (under category "Bebidas") ---
  {
    ...
    price: 6.00,
    category: "Bebidas",
    image: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=500&h=350&fit=crop&q=80",
    rating: 5.0,
    prepTime: "2-5 min",
    ingredients: [],
    availableToppings: []
  ...
  },
  {
    ...
    price: 6.00,
    category: "Bebidas",
    image: "/src/assets/images/fanta_grape_1781053559514.png",
    rating: 5.0,
    prepTime: "2-5 min",
    ingredients: [],
    availableToppings: []
  },
  {
    ...
    price: 6.00,
    category: "Bebidas",
    image: "/src/assets/images/fanta_orange_1781053576954.png",
    rating: 5.0,
    prepTime: "2-5 min",
    ingredients: [],
    availableToppings: []
  },
  {
    ...
    price: 6.00,
    category: "Bebidas",
    image: "/src/assets/images/sprite_can_1781053591910.png",
    rating: 5.0,
    prepTime: "2-5 min",
    ingredients: [],
    availableToppings: []
  },
  {
    ...
    price: 10.00,
    category: "Bebidas",
    image: "/src/assets/images/summer_orange_juice_1781053918553.png",
    rating: 5.0,
    prepTime: "3-5 min",
    ingredients: [],
    availableToppings: []
  },
  {
    ...
    price: 15.00,
    category: "Bebidas",
    image: "/src/assets/images/coca_cola_2l_1781053935428.png",
    rating: 5.0,
    prepTime: "2-5 min",
    ingredients: [],
    availableToppings: []
